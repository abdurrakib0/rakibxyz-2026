  ...
  const channels = [
    {
      ...
      tags: ['Leadership', 'Career Systems', 'Tech Hiring'],
    ...
    },
    {
      ...
      tags: ['Podcasts', 'Keynotes', 'Tech Roadmaps'],
    ...
    },
    {
      ...
      tags: ['Community', 'Live Sessions', 'Updates'],
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center justify-between gap-3">
                ...
                {/* Follower / Subscriber Highlight Badge */}
                <span className={`font-mono text-[0.6875rem] px-2.5 py-1 rounded-full border font-semibold ${ch.badgeBg}`}>
                  Live Channel
                </span>
              </div>
              ...
              <div className="flex items-center gap-1.5 flex-wrap pt-1">
                {ch.tags.map((tag, idx) => (
                  <span
                    key={idx}
                    className="font-mono text-[0.6875rem] px-2 py-0.5 rounded bg-[var(--bg)] border border-[var(--rule)] text-[var(--ink-muted)]"
                  >
                    #{tag}
                  </span>
                ))}
